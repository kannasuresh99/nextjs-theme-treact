...
const ImageContainer = styled.div`
  ${tw`md:mx-3 lg:mx-6 w-2/3 md:w-4/12 rounded-md flex items-center max-w-xs md:max-w-none`}
  img {
    ${tw`rounded-md`}
  }
`;
...
const SliderControlButtonContainer = styled.div`
  ...
  button {
    ${tw`text-secondary-500 hover:text-primary-500 focus:outline-none transition-transform duration-300 transform hover:scale-125 transform -translate-y-2/3 md:translate-y-0`}
    svg {
      ${tw`w-8`}
    }
  }
