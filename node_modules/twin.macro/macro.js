...
var reorderAtRules = function (className) { return className && Object.entries(className).sort(function (a, b) {
  var aKey = a[0];
  var bKey = b[0];
...
var getStyleData = (function (classes, ref) {
  ...
  var styles = classes.reduce(function (results, classNameRaw) {
    ...
    !silentMismatches && doPrechecks([precheckGroup, preCheckPrefix], {
      pieces: pieces,
      classNameRaw: classNameRaw,
      state: state
